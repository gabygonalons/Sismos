...
st.markdown('<a href="http://54.233.115.161:8501/" target="_blank"><style>.primary {color:#FAF8F8;background-color: linear-gradient(90deg,#20252C,#515353);padding:14px, 28px; font-size:20px; border: 1px solid #6E6F6F; border-radius:7px; border-style:inset; cursor: pointer}</style><button class="primary">Earthquake Classification APP</button></a>', unsafe_allow_html=True)
