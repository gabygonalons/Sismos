...
with col2:
    ...
    st.markdown("<div style='display: flex; justify-content: center;'><a href='https://www.linkedin.com/in/maximiliano-baldom%C3%A1-182056238/'>Linkedin</a></div>", unsafe_allow_html=True)hbnm
