...
with col1:
    ...
    st.image(gaby)
    st.markdown("<h4 style= 'text-align: center;'>Gabriela Goñalons</h4>", unsafe_allow_html=True)
...
with col2:
    ...
    st.image(maxi)
    st.markdown("<h4 style= 'text-align: center;'>Maximiliano Baldomá</h4>", unsafe_allow_html=True)
...
with col3:
    ...
    st.image(juanma)
    st.markdown("<h4 style= 'text-align: center;'>Juan Manuel Rossi</h4>", unsafe_allow_html=True)
    st.markdown("<p style= 'text-align: center;'>Data Engeneer</p>", unsafe_allow_html=True)
...
with col4:
    ...
    st.image(ivan)
    st.markdown("<h4 style= 'text-align: center;'>Iván Cepeda</h4>", unsafe_allow_html=True)
    st.markdown("<p style= 'text-align: center;'>Data Analyst</p>", unsafe_allow_html=True)
