...
#Título 2
st.markdown("## ¿Por qué realizar este sistema de notificaciones sísmicas?")
#parrafo 2
st.markdown("Los avances tecnológicos han permitido el accceso a los datos prácticamente en tiempo real desde cualquier lugar del planeta, no obstante la captación de datos se realiza desde diversas instituciones en distintos puntos del platena con equipamientos variados. Consecuentemente los datos resultantes de los monitoreos realizados presetan disímiles formatos y calidades por lo que resulta imperioso el pre-procesamiento de los mismos y su adecuación a los estandares de la Red.")
#Titulo h2
st.markdown("## Misión")
#Parrafo
st.markdown("Proveer a la alianza tri-nacional los datos requeridos en formatos acordes a los estándares de la red en plazos que permitan el cumplimiento cabal de los objetivos.")
#Título h2
st.markdown("## Visión")
#Parrafo
...
#Parrafo 
st.markdown("Crear una base de datos, con información sobre la actividad sísmica de los países miembros de la alianza: Estados Unidos, Japón y México.")
